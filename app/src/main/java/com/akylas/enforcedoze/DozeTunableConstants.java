...
public final class DozeTunableConstants {
    ...
    public static final String KEY_MAX_TEMP_APP_WHITELIST_DURATION =
            "max_temp_app_whitelist_duration";
    public static final String KEY_MMS_TEMP_APP_WHITELIST_DURATION =
            "mms_temp_app_whitelist_duration";
    public static final String KEY_SMS_TEMP_APP_WHITELIST_DURATION =
            "sms_temp_app_whitelist_duration";
    public static final String KEY_NOTIFICATION_WHITELIST_DURATION =
