...
public class SessionPolicyTest {
    @Test
    public void midnightPeriodIncludesStartExcludesEnd() {
    ...
    @Test
    public void malformedPeriodsAreRejected() {
        for (String s :
                new String[] {null, "", "-1:00-23:00", "12:99-22:00", "00:00-00:00", "text"})
            assertNull(ScheduleRules.parse(s));
    }

    @Test
    public void everyEntryGateAppliesToStartupAndDelay() {
    ...
    @Test
    public void chargingMissingAndInterruptedReadingsNeverBecomeConsumption() {
